...
coss.idc= {
    ...
    controller: function (scope,service,echartsOption) {
        ...
        //图形
        scope.listData = coss.idc.listData(scope,service);
        scope.checkSanshuiStatistics = coss.idc.checkSanshuiStatistics(scope,service,echartsOption);
    ...
    //三水机房核对
    checkSanshuiStatistics: function (scope,service,echartsOption) {
        //趋势图
...
//                _postParams.wheres.push({name: "time", value: scope.time +  " 23:59:59", operator: "lte", valueType: "DATETIME"});
                _postParams.wheres.push({name: "rname", value:"三水机房", operator: "eq", valueType: "STRING"});
...
//                        var legend = {x: 'left',y:'top'};
    ...
    listData: function (scope,service) {
        ...
        _events = {
            update: function (params) {
                ...
                _postParams.resultColumns = ["rname"];             
                _postParams.wheres = [];
                _postParams.wheres.push({name: "time", value: scope.logTime, operator: "eq", valueType: "STRING"});
//                _postParams.wheres.push({name: "time", value: scope.time +  " 23:59:59", operator: "lte", valueType: "DATETIME"});
 ...
 * angular的各种模块注册
 */
angular.module('idc.controller', [])
        .controller('idcCtrl', ['$scope', 'Coss', 'echartsOption', coss.idc.controller]);
